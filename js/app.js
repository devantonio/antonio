...
// function append_img_info1(){
//   $(".img-info-container div").append("<p class='img-info img-info1'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam vero ab neque, eligendi minus perferendis iusto, .</p><button class='info-btn'>Check it out</button>")
// }

// function append_img_info2(){
//   $(".img-info-container div").append("<p class='img-info img-info2'> consectetur adipisicing elit. Nam vero ab neque, eligendi minus perferendis iusto,Lorem ipsum dolor sit amet, .</p><button>Check it out</button>")
// }
...
function interval11(){
    interval = setInterval(function(){click =0; start();}, 24000);
}
interval11();
start();
...
//console.log(timeout2);//.click(function(){return false;});
function start1(){
...
// function start2(){
//   timeout4 = setTimeout(function(){callNext()}, 5000);
// }
...
//every click run a 5 sec timeout function that disables click for 5secs
...
$(window).on("scroll", function(e) {
  ...
  if ($(window).scrollTop() > 360 )  {
    nav.addClass("fix");
    //$(".img-info-container").addClass("top");
 } else {
     nav.removeClass("fix");
  $(".img-info-container").removeClass("top");
   }
   if($(window).scrollTop() > 360){
...
function openNav() {
  if(!$(".line1").hasClass("open1")){
     ...
     // $(".line1").removeClass("close1");
     // $(".line2").removeClass("close2");
     // $(".line3").removeClass("close3");
    ...
    $("#mySidenav hr").css("right", "-135px");
     ...
     // $(".line2").removeClass("close2");
     // $(".line3").removeClass("close3");
     // if($(".mobile-menu").offset() == 210 && $(".mobile-menu").hasClass("translate-close")){
     //  $(".mobile-menu").removeClass("fix1");
     // }
  }
...
//  if (x.top > 330 && $(".line1").hasClass("open1"))  {
//   $(".mobile-menu").removeClass("translate-open"); 
